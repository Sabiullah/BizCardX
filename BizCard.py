...
image_directory = r"C:\Users\safyc\Desktop\Pythonfiles"


# SETTING PAGE CONFIGURATIONS
icon_path = os.path.join(image_directory, "card.jpeg")
icon = Image.open(icon_path)
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By SAFY",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *SAFY*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:/Users/safyc/Desktop/Pythonfiles/card.jpeg"), width=500)
        st.markdown("## :green[**Technologies Used :**] Python,easy OCR, Streamlit, SQL, Pandas")
    with col2:
        st.write(
            "## :green[**About :**] Bizcard is a Python application designed to extract information from business cards.")
        st.write(
            '## Bizcard is designed to streamline the extraction of crucial information from images of business cards. This includes details like the persons name, job title, company, contact information, and other pertinent data. It achieves this by utilizing OCR (Optical Character Recognition) capabilities offered by EasyOCR to extract text from the images.')
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            uploaded_cards_dir = os.path.join(image_directory, "uploaded_card")
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.path.join(uploaded_cards_dir, uploaded_card.name)
                ...
                # easy OCR
        # saved_img = os.getcwd() + "\\" + "uploaded_card" + "\\" + uploaded_card.name
        saved_img = os.path.join(image_directory, "uploaded_card", uploaded_card.name)
